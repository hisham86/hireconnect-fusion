  ...
  return (
    ...
    >
      ...
      <mesh position={[0, 0.8, 0]}>
        ...
        <meshStandardMaterial args={[{ color: hover ? "#9b87f5" : "#8B5CF6" }]} />
      </mesh>
      
      {/* Head */}
      <mesh ref={headRef} position={[0, 2.3, 0]}>
        <boxGeometry args={[1, 1, 1]} />
        <meshStandardMaterial args={[{ color: "#7E69AB" }]} />
        
        {/* Eyes */}
        <mesh position={[0.3, 0.1, 0.51]}>
          <sphereGeometry args={[0.1, 16, 16]} />
          <meshStandardMaterial args={[{ color: "#E5DEFF" }]} />
        </mesh>
        ...
        <mesh position={[0, 0.6, 0]}>
          ...
          <meshStandardMaterial args={[{ color: "#D946EF" }]} />
        </mesh>
      ...
      <mesh ref={leftArmRef} position={[-1, 0.8, 0]}>
        ...
        <meshStandardMaterial args={[{ color: "#6E59A5" }]} />
      </mesh>
      ...
      <mesh position={[-0.5, -0.8, 0]}>
        ...
        <meshStandardMaterial args={[{ color: "#1A1F2C" }]} />
      </mesh>
