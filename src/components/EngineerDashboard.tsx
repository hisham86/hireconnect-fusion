...
const EngineerDashboard = () => {
  ...
  const renderApplyButton = (job: any) => {
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center">
                      ...
                      <p className="text-sm">Next Interview: <span className="font-medium">
                        {jobApplications.some(job => job.status?.includes("Interview")) 
                          ? "Scheduled" 
                          : "None scheduled"}
                      </span></p>
                    </div>
                  ...
                  <div className="pt-3 border-t border-gray-200">
                    ...
                    <div className="flex flex-wrap gap-2 mt-3">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          // Demo add a language for simplicity
          ...
          <Card className="overflow-hidden">
            ...
            >
              ...
              <TabsContent value="active">
                {jobApplications.length === 0 ? (
                  <div className="p-8 text-center">
                    <h3 className="text-lg font-semibold mb-2">No active job applications yet</h3>
                    <p className="text-gray-600 mb-4">Track your job applications by adding them manually</p>
                    <Button 
                      onClick={() => setIsAddJobDialogOpen(true)}
                      className="flex items-center gap-1"
                    >
              ...
              <TabsContent value="suitable">
                {suggestedJobs.length === 0 ? (
                  <div className="p-8 text-center">
                    ...
                    <p className="text-gray-600">Job suggestions will appear here based on your profile</p>
                  </div>
                ) : (
                  <Table>
                    <TableHeader>
              ...
              <TabsContent value="all">
                {jobApplications.length === 0 && suggestedJobs.length === 0 ? (
                  <div className="p-8 text-center">
                    <h3 className="text-lg font-semibold mb-2">No jobs found</h3>
                    <p className="text-gray-600 mb-4">Start by adding a job application or checking suggested jobs</p>
                    <Button 
                      onClick={() => setIsAddJobDialogOpen(true)}
                      className="flex items-center gap-1"
                    >
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {getSortedJobs([...jobApplications, ...suggestedJobs.map(job => ({
                        ...job,
                        status: "Not Applied",
                        isSuggested: true
                      }))]).map((job) => (
